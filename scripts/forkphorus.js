		...
		(function (t) {
				...
				p = function (t, e, i) {
					if (null != t || null != e || null != i) {
						...
						"string" == typeof t && (t = c.getElementById(t)),
							...
							(t.childNodes && 1 == t.childNodes.length && "OBJECT" == t.childNodes[0].nodeName) ||
								(t.svg = n);
			...
			function m(s) {
				...
				1 == D.opts.log &&
					...
					(D.ajax = function (t) {
						var e;
						return (e = l.XMLHttpRequest ? new l.XMLHttpRequest() : new ActiveXObject("Microsoft.XMLHTTP"))
					...
					(D.parseXml = function (e) {
						...
						try {
							...
							return (n = s.xmldom ? new l.DOMParser(s.xmldom) : new l.DOMParser()).parseFromString(
								e,
								"text/xml"
							);
						}
				...
				return (
								...
								n.fontStyle || -1 == r.Styles.indexOf(i[a])
									? n.fontVariant || -1 == r.Variants.indexOf(i[a])
										? n.fontWeight || -1 == r.Weights.indexOf(i[a])
											? n.fontSize
												? "inherit" != i[a] && (s += i[a])
												: ("inherit" != i[a] && (e.fontSize = i[a].split("/")[0]),
												  (n.fontStyle = n.fontVariant = n.fontWeight = n.fontSize = !0))
					...
					(D.ToNumberArray = function (t) {
						for (
							var e = (t || "").match(/-?(\d+(?:\.\d*(?:[eE][+-]?\d+)?)?|\.\d+)(?=\D|$)/gm) || [], i = 0;
							i < e.length;
							i++
						)
							e[i] = parseFloat(e[i]);
							...
							h.hasValue() && l.hasValue()
								...
								: (u.match(/^xMid/) &&
								  ...
								  u.match(/YMax$/) &&
										(("meet" == c && d == f) || ("slice" == c && m == f)) &&
										t.translate(0, s - a)),
							"none" == u ? t.scale(f, p) : "meet" == c ? t.scale(d, d) : "slice" == c && t.scale(m, m),
					...
					(D.Element.ElementBase = function (a) {
						(this.attributes = {}),
							...
							(this.attribute = function (t, e) {
								...
								return null != i
									? i
									: (1 == e && ((i = new D.Property(t, "")), (this.attributes[t] = i)),
									  i || D.EmptyProperty);
							}),
							...
							(this.style = function (t, e, i) {
								...
								return (
									1 == e && ((n = new D.Property(t, "")), (this.styles[t] = n)), n || D.EmptyProperty
								);
							}),
									...
									if ("@" != t[0] && f(a, t)) {
										...
										if (null != e)
											for (var n in e) {
												...
												void 0 === s && (s = "000"),
													s <= i &&
														((this.styles[n] = e[n]), (this.stylesSpecificity[n] = i));
											}
									}
							});
						var t,
						...
						(this.base = D.Element.ElementBase),
							...
							(this.setContext = function (t, e) {
								if (!e) {
									...
									if (this.style("fill").isUrlDefinition())
										...
										"currentColor" == (n = this.style("fill")).value &&
											...
											"inherit" != n.value &&
												(t.fillStyle = "none" == n.value ? "rgba(0,0,0,0)" : n.value);
									}
									...
									if (this.style("stroke").isUrlDefinition())
										...
										"currentColor" == (s = this.style("stroke")).value &&
											...
											"inherit" != s.value &&
												(t.strokeStyle = "none" == s.value ? "rgba(0,0,0,0)" : s.value);
									}
									if (this.style("stroke-opacity").hasValue())
										(s = (s = new D.Property("stroke", t.strokeStyle)).addOpacity(
											this.style("stroke-opacity")
										)),
									...
									if (
										...
										void 0 !== t.setLineDash
											...
											? (t.webkitLineDash = r)
											: void 0 === t.mozDash || (1 == r.length && 0 == r[0]) || (t.mozDash = r);
								...
								this.style("transform", !1, !0).hasValue() &&
									new D.Transform(this.style("transform", !1, !0).value).apply(t);
					...
					(D.Element.svg = function (t) {
						(this.base = D.Element.RenderedElementBase),
							...
							(this.setContext = function (t) {
								if (
									(D.SetDefaults(t),
									t.canvas.style && void 0 !== t.font && void 0 !== l.getComputedStyle)
								) {
								...
								if (
									...
									t.beginPath(),
										0 < s &&
											...
											(t.moveTo(e + a, i),
											t.lineTo(e + n - a, i),
											t.bezierCurveTo(e + n - a + o * a, i, e + n, i + r - o * r, e + n, i + r),
											t.lineTo(e + n, i + s - r),
											t.bezierCurveTo(
												e + n,
												i + s - r + o * r,
											...
											t.lineTo(e + a, i + s),
											t.bezierCurveTo(e + a - o * a, i + s, e, i + s - r + o * r, e, i + s - r),
											t.lineTo(e, i + r),
											t.bezierCurveTo(e, i + r - o * r, e + a - o * a, i, e + a, i),
											t.closePath());
								}
					...
					(D.Element.line = function (t) {
						(this.base = D.Element.PathElementBase),
							...
							(this.getPoints = function () {
								return [
									new D.Point(this.attribute("x1").toPixels("x"), this.attribute("y1").toPixels("y")),
									new D.Point(this.attribute("x2").toPixels("x"), this.attribute("y2").toPixels("y"))
								];
							}),
							(this.path = function (t) {
								var e = this.getPoints();
								return (
									null != t && (t.beginPath(), t.moveTo(e[0].x, e[0].y), t.lineTo(e[1].x, e[1].y)),
					...
					(D.Element.polyline = function (t) {
						(this.base = D.Element.PathElementBase),
							...
							(this.getMarkers = function () {
								...
								return (
									0 < t.length && t.push([this.points[this.points.length - 1], t[t.length - 1][1]]), t
								);
							});
					}),
					...
					(D.Element.path = function (t) {
						...
						e = (e = e.replace(/([^\s])([MmZzLlHhVvCcSsQqTtAa])/gm, "$1 $2")).replace(
							/([0-9])([+\-])/gm,
							"$1 $2"
						);
									...
									switch ((e.nextCommand(), e.command)) {
										...
										case "c":
											for (; !e.isCommandOrEnd(); ) {
												...
												e.addMarker(l, h, o),
													i.addBezierCurve(r.x, r.y, o.x, o.y, h.x, h.y, l.x, l.y),
													null != t && t.bezierCurveTo(o.x, o.y, h.x, h.y, l.x, l.y);
											}
											break;
										case "S":
										case "s":
										...
										case "a":
											for (; !e.isCommandOrEnd(); ) {
												...
												var g = new D.Point((v * u * m.y) / c, (v * -c * m.x) / u),
													x = new D.Point(
														(r.x + l.x) / 2 + Math.cos(f) * g.x - Math.sin(f) * g.y,
														(r.y + l.y) / 2 + Math.sin(f) * g.x + Math.cos(f) * g.y
													),
													b = function (t) {
													...
													E = function (t, e) {
														return (
															(t[0] * e[1] < t[1] * e[0] ? -1 : 1) * Math.acos(P(t, e))
														);
													},
						...
						(this.base = D.Element.ElementBase),
							...
							(this.createPattern = function (t, e, i) {
								var n = this.attribute("width").toPixels("x", !0),
									...
									a = new D.Element.svg();
								(a.attributes.viewBox = new D.Property("viewBox", this.attribute("viewBox").value)),
						...
						(this.getGradient = function () {}),
							...
							(this.createGradient = function (t, e, i) {
								...
								if (this.attribute("gradientTransform").hasValue()) {
									...
									(h.attributes.x = new D.Property("x", -D.MAX_VIRTUAL_PIXELS / 3)),
										(h.attributes.y = new D.Property("y", -D.MAX_VIRTUAL_PIXELS / 3)),
										(h.attributes.width = new D.Property("width", D.MAX_VIRTUAL_PIXELS)),
										(h.attributes.height = new D.Property("height", D.MAX_VIRTUAL_PIXELS));
						...
						(this.base = D.Element.AnimateBase),
							...
							(this.calcValue = function () {
								...
								if (e.ok && i.ok) {
									...
									return (
										"rgb(" + parseInt(n, 10) + "," + parseInt(s, 10) + "," + parseInt(a, 10) + ")"
									);
								}
						...
						(this.captureTextNodes = !0),
							...
							(this.adjustChildCoordinates = function (t, e, i, n) {
								...
								if (s.attribute("x").hasValue()) {
									...
									s.attribute("dx").hasValue() && (e.x += s.attribute("dx").toPixels("x")),
										(s.x = e.x);
								return (
									(e.x = s.x + s.measureText(t)),
									s.attribute("y").hasValue()
										? ((s.y = s.attribute("y").toPixels("y")),
										  s.attribute("dy").hasValue() && (s.y += s.attribute("dy").toPixels("y")))
										: (s.attribute("dy").hasValue() && (e.y += s.attribute("dy").toPixels("y")),
										  (s.y = e.y)),
									(e.y = s.y),
									s
								);
						...
						(this.base = D.Element.RenderedElementBase),
							...
							(this.renderChildren = function (t) {
								...
								if (null == e)
									"stroke" == t.paintOrder
										? ("" != t.strokeStyle &&
												t.strokeText(D.compressSpaces(this.getText()), this.x, this.y),
										  "" != t.fillStyle &&
												t.fillText(D.compressSpaces(this.getText()), this.x, this.y))
										: ("" != t.fillStyle &&
												t.fillText(D.compressSpaces(this.getText()), this.x, this.y),
										  "" != t.strokeStyle &&
												t.strokeText(D.compressSpaces(this.getText()), this.x, this.y));
									...
									for (
										var a = D.ToNumberArray(this.parent.attribute("dx").value), r = 0;
										r < s.length;
										r++
									) {
							...
							(this.renderChildren = function (t) {
								...
								for (var a = 0; a < n.length; a++) {
									...
									t.save(),
										...
										"" != t.strokeStyle && t.strokeText(D.compressSpaces(h), 0, 0),
										t.restore(),
										"underline" === e &&
											(0 === a && t.moveTo(r.x, r.y + i / 8), t.lineTo(o.x, o.y + i / 5));
								}
								"underline" === e &&
									((t.lineWidth = i / 20), (t.strokeStyle = s), t.stroke(), t.closePath()),
									t.restore();
							}),
							(this.path = function (t) {
								...
								if (!this.hasOwnProperty("glyphInfo")) {
									...
									var m = function (t, e) {
										...
										" " === t && "justify" === l && c < f && (n += (f - c) / h),
											-1 < e && (d += ((i = (i = e) || 0), o.letterSpacingCache[i] || 0));
										...
										case "a":
											for (; !i.isCommandOrEnd(); ) {
												...
												var E = new D.Point((P * d * x.y) / m, (P * -m * x.x) / d),
													w = new D.Point(
														(p.x + f.x) / 2 + Math.cos(y) * E.x - Math.sin(y) * E.y,
														(p.y + f.y) / 2 + Math.sin(y) * E.x + Math.cos(y) * E.y
													),
													C = function (t) {
														return Math.sqrt(Math.pow(t[0], 2) + Math.pow(t[1], 2));
													},
								...
								switch (i) {
									...
									case "A":
										...
										if (
											...
											(a = this.getPointOnEllipticalArc(n[0], n[1], n[2], n[3], h, 0)),
											l < 0)
										)
											for (o = h - c; u < o; o -= c)
											...
											for (o = h + c; o < u; o += c)
												(r = this.getPointOnEllipticalArc(n[0], n[1], n[2], n[3], o, 0)),
													...
													(a = r);
										return (
											(r = this.getPointOnEllipticalArc(n[0], n[1], n[2], n[3], u, 0)),
											(s += this.getLineLength(a.x, a.y, r.x, r.y))
										);
								}
								return 0;
					...
					(D.Element.style = function (t) {
						...
						for (i = 0; i < n.length; i++)
							if ("" != D.trim(n[i]))
								for (
									var s = n[i].split("{"), a = s[0].split(","), r = s[1].split(";"), o = 0;
									o < a.length;
									o++
								) {
									var h = D.trim(a[o]);
										...
										if (((D.Styles[h] = l), (D.StylesSpecificity[h] = P(h)), "@font-face" == h))
											for (
												...
												if (0 < m[y].indexOf('format("svg")')) {
													...
													if (v)
														for (
															var g = D.parseXml(D.ajax(v)).getElementsByTagName("font"),
																x = 0;
															x < g.length;
															x++
														) {
					...
					(D.Element.filter = function (t) {
						(this.base = D.Element.ElementBase),
							...
							(this.apply = function (t, e) {
								...
								t.drawImage(f, 0, 0, a + 2 * h, r + 2 * l, n - h, s - l, a + 2 * h, r + 2 * l),
						...
						(this.base = D.Element.ElementBase),
							...
							(this.apply = function (t, e, i, n, s) {
								v && void 0 !== v.canvasRGBA
									...
									: D.log("ERROR: StackBlur.js must be included for blur to work");
							});
					}),
					...
					(D.CreateElement = function (t) {
						...
						var i = null;
						return (
							((i = void 0 !== D.Element[e] ? new D.Element[e](t) : new D.Element.MISSING(t)).type =
								t.nodeName),
							i
						);
					}),
							...
							n = function () {
								D.ViewPort.Clear(),
									...
									1 != D.opts.ignoreDimensions &&
										(h || (null == D.opts.scaleWidth && null == D.opts.scaleHeight)) &&
										(o.style("width").hasValue() &&
											((a.canvas.width = o.style("width").toPixels("x")),
											a.canvas.style && (a.canvas.style.width = a.canvas.width + "px")),
										o.style("height").hasValue() &&
											((a.canvas.height = o.style("height").toPixels("y")),
											a.canvas.style && (a.canvas.style.height = a.canvas.height + "px")));
								...
								if (
									...
									null != D.opts.scaleWidth &&
										(o.attribute("width").hasValue()
											? (i = o.attribute("width").toPixels("x") / D.opts.scaleWidth)
											: isNaN(s[2]) || (i = s[2] / D.opts.scaleWidth)),
										null != D.opts.scaleHeight &&
											(o.attribute("height").hasValue()
												? (n = o.attribute("height").toPixels("y") / D.opts.scaleHeight)
